...
const dummyAuctions: Auction[] = [
  ...
  { id: 2, name: "스마트폰 경매", product: "스마트폰", seller: "김철수", start: "2024-06-02", end: "2024-06-06", status: "종료", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80" },
  ...
  { id: 4, name: "커피머신 경매", product: "커피머신", seller: "박민수", start: "2024-06-04", end: "2024-06-08", status: "종료", image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=400&q=80" },
  ...
  { id: 6, name: "모니터 경매", product: "모니터", seller: "정우성", start: "2024-06-06", end: "2024-06-10", status: "종료", image: "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80" },
  ...
  { id: 8, name: "스피커 경매", product: "스피커", seller: "박지성", start: "2024-06-08", end: "2024-06-12", status: "종료", image: "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" },
  ...
  { id: 10, name: "램프 경매", product: "램프", seller: "손흥민", start: "2024-06-10", end: "2024-06-14", status: "종료", image: "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=400&q=80" },
];
