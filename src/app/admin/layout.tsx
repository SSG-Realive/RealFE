...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      {/* 모바일 오버레이용 사이드바 */}
      <div id="mobile-sidebar-overlay" className="fixed inset-0 z-40 bg-black bg-opacity-40 hidden" onClick={() => { document.getElementById('mobile-sidebar')?.classList.add('translate-x-[-100%]'); document.getElementById('mobile-sidebar-overlay')?.classList.add('hidden'); }} />
      <div id="mobile-sidebar" className="fixed top-0 left-0 h-full w-[220px] bg-gray-900 text-gray-200 z-50 p-6 transition-transform duration-300 -translate-x-full md:hidden">
