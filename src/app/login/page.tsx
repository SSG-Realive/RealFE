...
export default function IntegratedLoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center
                     justify-center bg-white px-4 py-10">
      ...
      <div className="z-10 w-full max-w-2xl text-center space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href={customerLoginUrl} className="group">
            <div className="p-8 bg-white rounded-lg border shadow-sm
                            hover:shadow-xl hover:border-blue-500 transition h-full">
          ...
          <Link href={sellerLoginUrl} className="group">
            <div className="p-8 bg-white rounded-lg border shadow-sm
                            hover:shadow-xl hover:border-green-500 transition h-full">
              <div className="flex justify-center mb-4">
        ...
        <footer className="text-xs text-gray-300 mt-4">
          © 2025 Realive. All rights reserved.
        </footer>
      </div>
    </main>
  );
