...
export default function ProductDetailPage() {
  ...
  return (
    <div>
          ...
          <div className="border-t border-b py-6 mb-8">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full border bg-white hover:bg-gray-100"
              >
                {isWished ? (
              ...
              <button
                ...
                className="flex-1 px-5 py-3 border rounded-lg bg-white hover:bg-gray-100 text-sm font-semibold"
              >
                장바구니
              </button>
              ...
              <button
                ...
                className="flex-1 px-5 py-3 rounded-lg bg-black text-white hover:bg-gray-900 text-sm font-semibold"
              >
                바로 구매
              </button>
            </div>
      ...
      {/* -------------------- 고정 하단 주문 바 -------------------- */}
      <div
        className={`fixed bottom-0 left-0 right-0 bg-white border-t p-4 shadow-lg transition-transform duration-300 ${
