      ...
      <nav>
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, boxSizing: 'border-box' }}>
          ...
          <li style={{ margin: '18px 0', display: 'flex', alignItems: 'center' }}>
            <Link href="/admin/customers" style={{ flex: 1 }}>회원</Link>
            <button
          ...
          <Accordion open={customerOpen}>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, marginLeft: 16, boxSizing: 'border-box' }}>
              <li style={{ margin: 0, boxSizing: 'border-box', padding: '0 0 8px 0' }}><Link href="/admin/customers/list">고객 관리</Link></li>
              <li style={{ margin: 0, boxSizing: 'border-box', padding: '8px 0' }}><Link href="/admin/customers/penalty">사용자 패널티</Link></li>
            </ul>
          </Accordion>
