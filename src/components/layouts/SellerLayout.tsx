      ...
      <div className="flex flex-col lg:flex-row flex-1 w-full min-h-screen">
        ...
        <div className="lg:hidden">
          <SellerSidebar 
            ...
            className={`fixed z-50 top-0 left-0 min-h-screen h-full w-60 bg-gray-800 text-white flex-shrink-0 flex flex-col transition-transform duration-300 ease-in-out ${
        ...
        <div className="hidden lg:block">
          <SellerSidebar className="fixed top-0 left-0 h-screen w-60 bg-gray-800 text-white flex flex-col z-30" />
        </div>
        {/* 본문: flex-1로 꽉 차게, 데스크탑에서 사이드바만큼 마진 */}
        <main className="flex-1 w-full min-h-screen px-4 py-8 bg-gray-100 lg:ml-60">
          {children}
        </main>
      </div>
    </div>
